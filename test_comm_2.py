...
def on_game_processed(network_game, notification):
    print(
        "({}/{}): notification received {} for role = {}".format(
            network_game.get_current_phase(),
            network_game.power.name,
            notification.name,
...
def on_message_received(network_game, notification):
    ...
    print(
        "({}/{}): {} received the following message from {}: \n\t{}".format(
            network_game.get_current_phase(), notification.game_role, recipient, sender, message
        )
    )
