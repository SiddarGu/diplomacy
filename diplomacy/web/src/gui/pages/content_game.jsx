...
export class ContentGame extends React.Component {
  ...
  renderPastMessages(engine, role) {
    ...
    const convList = tabNames.map((protagonist) => (
      <div style={{ minWidth: "200px" }}>
        <Conversation
          className={
            protagonist === currentTabId ? "cs-conversation--active" : null
          }
          onClick={() => {
  ...
  renderCurrentMessages(engine, role) {
            ...
            <div id={messageId}>
              <Col>
                <input
                  ...
                  onClick={() => {
                    this.handleRecipientAnnotation(msg, "yes");
                  }}
                  disabled={
                    engine.role === "omniscient_type" ||
                    engine.role === "observer_type" ||
                ...
                <input
                  ...
                  onClick={() => this.handleRecipientAnnotation(msg, "None")}
                  disabled={
                    engine.role === "omniscient_type" ||
                    engine.role === "observer_type" ||
                    engine.role === "master_type"
    ...
    return (
      <Box
        sx={{ width: "100%", height: "550px", maxHeight: "550px", mb: "30px" }}
      >
      ...
      <main>
        ...
        <div>
          ...
          <Row className={"mb-4"}>
            ...
            {this.renderTabCentaurMessages(true, engine, currentPowerName)}
          </Row>
