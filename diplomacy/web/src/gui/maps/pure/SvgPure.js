        ...
        return (
            ...
            >
                ...
                <g id="MapLayer">
                    ...
                    />{" "}
                    <path
                        d="M497.619 30.1868 L866.51 207.835 L957.619 607.008 L702.338 927.12 L292.9 927.12 L37.6191 607.008 L128.728 207.835 z"
                        fill="none"
                        id="001"
                        stroke="black"
                        strokeWidth="3"
                    />{" "}
                    <path
                        d="M497.619 142.283 L650.619 176.571 L774.287 275.519 L842.619 416.571 L842.619 574.899 L773.619 715.571 L651.158 814.983 L497.619 849.571 L344.08 814.983 L220.619 716.571 L152.619 574.899 L152.619 416.571 L220.951 275.519 L343.619 176.571 z"
                        fill="rgb(240,237,168)"
                        id="002"
                        stroke="black"
                        strokeWidth="3"
                    ...
                    <path
                        ...
                        d="M497.619 142.283 L650.619 176.571 L774.287 275.519 L866.51 207.835 L497.619 30.1868 z"
                        id="_vie"
                    />{" "}
                    <path
                        className={classes["_lon"]}
                        d="M774.287 275.519 L842.619 416.571 L842.619 574.899 L957.619 607.008 L866.51 207.835 z"
                        id="_lon"
                    />{" "}
                    <path
                        className={classes["_par"]}
                        d="M842.619 574.899 L773.619 715.571 L651.158 814.983 L702.338 927.12 L957.619 607.008 z"
                        id="_par"
                    />{" "}
                    <path
                        className={classes["_ber"]}
                        d="M651.158 814.983 L497.619 849.571 L344.08 814.983 L292.9 927.12 L702.338 927.12 z"
                        id="_ber"
                    />{" "}
                    <path
                        className={classes["_rom"]}
                        d="M344.08 814.983 L220.619 716.571 L152.619 574.899 L37.6191 607.008 L292.9 927.12 z"
                        id="_rom"
                    />{" "}
                    <path
                        className={classes["_mos"]}
                        d="M152.619 574.899 L152.619 416.571 L220.951 275.519 L128.728 207.835 L37.6191 607.008 z"
                        id="_mos"
                    />{" "}
                    <path
                        className={classes["_con"]}
                        d="M220.951 275.519 L343.619 176.571 L497.619 142.283 L497.619 30.1868 L128.728 207.835 z"
                        id="_con"
                    />{" "}
                </g>{" "}
                <text className={classes["CurrentNote"]} id="CurrentNote" x="15" y="25">
                    {nb_centers_per_power ? nb_centers_per_power : ""}
                </text>{" "}
                <text className={classes["CurrentNote2"]} id="CurrentNote2" x="15" y="50">
                    {note ? note : ""}
                </text>{" "}
                <text
                    className={classes["CurrentPhase"]}
                    fontSize="30"
                    id="CurrentPhase"
                    x="845"
                    y="970"
