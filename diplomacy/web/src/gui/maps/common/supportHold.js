...
export class SupportHold extends React.Component {
    render() {
        ...
        const [symbol_loc_x, symbol_loc_y] = centerSymbolAroundUnit(
            Coordinates,
            SymbolSizes,
            dest_loc,
            false,
        ...
        dest_loc_x =
            "" +
            Math.round(
                (parseFloat(loc_x) + ((vector_length - delta_dec) / vector_length) * delta_x) * 100
            ) /
                100;
        dest_loc_y =
            "" +
            Math.round(
                (parseFloat(loc_y) + ((vector_length - delta_dec) / vector_length) * delta_y) * 100
            ) /
                100;
