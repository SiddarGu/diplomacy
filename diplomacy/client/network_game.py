...
class NetworkGame(Game):
    ...
    add_on_game_log_received = _callback_setting_method(notifications.LogDataReceived)
    ...
    clear_on_game_log_received = _callback_clearing_method(notifications.LogDataReceived)
